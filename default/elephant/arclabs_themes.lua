--
-- Dynamic ArcLabs Theme Menu for Elephant/Walker
--
Name = "arclabsthemes"
NamePretty = "ArcLabs Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/arclabs/themes"
  local arclabs_path = os.getenv("ARCLABS_PATH") or ""
  local default_theme_dir = arclabs_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "arclabs-theme-set " .. theme_name,
            },
          })
        end
      end
